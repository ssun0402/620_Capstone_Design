    ...
    def video(self):
        ...
        while True :
            ...
            if name1 == r_name :
                ...
                #경로지정
                wav_path = os.path.join("C:/Users/gptjs/OneDrive/바탕 화면/GitHub/620_Capstone_Design", "voice3.mp3")
...
def main():
    face_recognition_process = Process(target=vv)
    speech_recognition_process = Process(target=speak_jetson)
