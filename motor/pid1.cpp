...
/* PID 상수*/
// 각도 PID
float kp_dL = 8; // 거리 10, 8
float kd_dL = 0.4; // 거리 0.4
float ki_dL = 0.5; // 0    
...
int main(){
    ...
    while (true){
        ...
        // 속도 설정 setting speed
        softPwmWrite(pwmPinA, min(pwmL, 52));  //52   // 뒤 64
        softPwmWrite(pwmPinB, min(pwmR, 59));  //55   // 뒤 62
